...
class OldTestamentReadingPage extends StatefulWidget {
  const OldTestamentReadingPage({super.key});

  @override
  State<OldTestamentReadingPage> createState() =>
      _OldTestamentReadingPageState();
}

class _OldTestamentReadingPageState extends State<OldTestamentReadingPage> {
  String? sefrSelectedVal =
      AppLists.namesOfChaptersOldTestament[MyConstVar.selectedChapter];
  ...
  void initState() {
    ...
    setState(() {
      ...
      sefrSelectedNum = List.generate(
          AppMaps.oldTestament["oldTestament"]
              [AppLists.namesOfChaptersOldTestament[mapIndex]][0]["total"],
          (index) => index,
          growable: true);
    });
  }
            ...
            children: [
              ...
              Center(
                child: DropdownButton2<String>(
                  ...
                  items: AppLists.namesOfChaptersOldTestament.map((e) {
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      mapIndex =
                          AppLists.namesOfChaptersOldTestament.indexOf(value!);
                ...
                items: List.generate(
                  ...
                  return DropdownMenuItem<int>(
                      ...
                      value: List.generate(
                          ...
                          (index) => index,
                          growable: true)[e],
                      child: Text(AppMaps.oldTestament["oldTestament"]
                              [AppLists.namesOfChaptersOldTestament[MyConstVar.selectedChapter]]
                          [e + 1]["title"]));
                }).toList(),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                          ...
                          InkWell(
                            ...
                            onTap: () => setState(() {
                              if (MyConstVar.es7a7Counter >= 1 &&
                                  MyConstVar.es7a7Counter <
                                      AppMaps
                                          .oldTestament["oldTestament"][AppLists
                                              .namesOfChaptersOldTestament[
                                          MyConstVar
                    ...
                    InkWell(
                      child: const Text("العهد الجديد",style: TextStyle(fontSize: 22)),
                      onTap: () {
